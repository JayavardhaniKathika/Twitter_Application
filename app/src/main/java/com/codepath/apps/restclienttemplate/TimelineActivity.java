...
public class TimelineActivity extends AppCompatActivity {
    ...
    private void loadMoreData() {
        ...
        client.getNextPageOfTweets(new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                ...
                try {
                   List<Tweet> tweets=Tweet.fromJonArray(jsonArray);
            ...
            public void onFailure(int statusCode, Headers headers, String response, Throwable throwable) {
                Log.e(TAG,"On failure LoadMoreData",throwable);
            }
    ...
    private void populateHomeTimeline() {
        client.getHomeTimeLine(new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                Log.i(TAG,"onSuccess"+json.toString());  //Log.i info level
                JSONArray jsonArray=json.jsonArray;
                try {
                    final List<Tweet> tweetFromNetwork=Tweet.fromJonArray(jsonArray);
                    adapter.clear();
                    ...
                    AsyncTask.execute(new Runnable() {
                        @Override
                        public void run() {
                            Log.i(TAG,"Saving Data to databse");
                            //insert users first
            ...
            @Override
            public void onFailure(int statusCode, Headers headers, String response, Throwable throwable) {
                Log.e(TAG,"onFailure",throwable);  //Log.e error level
            }
        });
    }
}